...
pub fn round_up_tp_nearest_pow2(v: usize) -> Result<usize> {
    1usize
...
#[test_case]
fn round_up_tp_nearest_pow2_tests() {
    assert_eq!(round_up_tp_nearest_pow2(0), Err("Out of Range"));
    assert_eq!(round_up_tp_nearest_pow2(1), Ok(1));
    assert_eq!(round_up_tp_nearest_pow2(2), Ok(2));
    assert_eq!(round_up_tp_nearest_pow2(3), Ok(4));
    assert_eq!(round_up_tp_nearest_pow2(4), Ok(4));
    assert_eq!(round_up_tp_nearest_pow2(5), Ok(8));
    assert_eq!(round_up_tp_nearest_pow2(6), Ok(8));
    assert_eq!(round_up_tp_nearest_pow2(7), Ok(8));
    assert_eq!(round_up_tp_nearest_pow2(8), Ok(8));
    assert_eq!(round_up_tp_nearest_pow2(9), Ok(16));
}
...
impl Header {
    ...
    fn provide(&mut self, size: usize, align: usize) -> Option<*mut u8> {
        let size = max(round_up_tp_nearest_pow2(size).ok()?, HEADER_SIZE);
